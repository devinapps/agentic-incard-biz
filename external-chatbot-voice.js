...
<div id="lqd-ext-voice-chatbot-wrapper">
	<style>
		#lqd-ext-voice-chatbot-wrapper.fullscreen {
			bottom: 0;
			right: 0;
			width: 100vw;
			height: 100vh;
		...
		<iframe
			...
			onload="
				...
				window.addEventListener('message', event => {
					...
					// Handle button click event from iframe
					if ( event.data.type === 'lqd-ext-voice-chatbot-start-btn-clicked') {
						console.log('Event call clicked');
