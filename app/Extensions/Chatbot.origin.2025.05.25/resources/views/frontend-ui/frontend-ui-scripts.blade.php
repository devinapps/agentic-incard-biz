        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('externalChatbot', (isEditor = false) => ({
                ...
                onMessageFieldInput(event) {
                    ...
                    if (messageString && !this.waitingResponse) {
                ...
                async onSendMessage() {
                    ...
                    if (!messageString || this.waitingResponse) return;

                    this.waitingResponse = true; // waiting for response
                    ...
                    @else
                        ...
                        if (loaderMessage != null) {
                            await this.onReceiveMessage(data.data, loaderMessage);
                            this.waitingResponse = false; // response completed
                        }
